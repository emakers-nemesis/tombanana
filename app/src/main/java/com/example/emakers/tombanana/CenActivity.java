...
public class CenActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_cen_ant = (Button) findViewById(R.id.btn_cen_ant);
        ...
        btn_cen_ant.setOnClickListener(this);
    }
    ...
    public void onClick(View v){
        switch (v.getId()) {
            ...
            case R.id.btn_cen_ant:
                Intent intent2 = new Intent(this, PraActivity.class);
